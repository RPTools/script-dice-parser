...
class ExecutorModuleTest {
  ...
  @Inject private InstructionExecutorFactory instructionExecutorFactory;
  @Inject private InterpreterFactory interpreterFactory;

  @BeforeEach
  public void setup() {
    Guice.createInjector(new ExecutorModule(), new MockModule(), BoundFieldModule.of(this))
        .injectMembers(this);
  }

  @Test
  public void executorFactory() {
    assertNotNull(instructionExecutorFactory);
  }

  @Test
  public void interpreterFactory() {
    assertNotNull(interpreterFactory.create(mock(SymbolTableStack.class)));
  }
}
