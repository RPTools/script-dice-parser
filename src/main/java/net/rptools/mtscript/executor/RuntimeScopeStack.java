 ...
 * same scope level.
 *
 * <p>This is used from within {@link net.rptools.mtscript.executor.RuntimeStack} to help tracking
 * stack frames. While the variable memory management could all be handled by a stack only it would
 * mean that searching for a symbol of the correct scoping level would require traversing the stack
 * backwards until you hit that scope level and as recursive calls can add multiple stack frames
